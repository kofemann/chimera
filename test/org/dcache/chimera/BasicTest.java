...
public class BasicTest extends ChimeraTestCaseHelper {
    ...
    public void testLs() throws Exception {
        ...
        assertTrue("Root Dir cant be empty", count > 0L);
    }
    ...
    public void testMkDirWithTags() throws Exception {
        ...
        FsInode dir1 = _fs.mkdir(_rootInode, "junit", 1, 2, 02755, Collections.emptyList(), Map.of("tag", bytes));
    ...
    public void testEmptyFsStat() throws ChimeraFsException {
        ...
        FsStat fsStat = _fs.getFsStat();
        assertEquals(0, fsStat.getUsedSpace());
        assertEquals(0, fsStat.getUsedFiles());
    }
